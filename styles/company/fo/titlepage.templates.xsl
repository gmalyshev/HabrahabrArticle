...
<xsl:template name="book.titlepage.recto">
  ...
  <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="bookinfo/city"/>
  <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="info/city"/>
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.recto.style" text-align="center" margin-top="7cm" font-size="12pt" space-before="18.6624pt" font-weight="bold" font-family="{$title.fontset}">
<xsl:call-template name="division.title">
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.recto.style" margin-top="4cm" text-align="center" hyphenate="false" font-family="{$title.fontset}" font-size="11pt" font-weight="bold">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="corpauthor" mode="book.titlepage.recto.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.recto.style" font-size="12pt" keep-with-next.within-column="always" space-before="hsize5space">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>
...
<xsl:template match="city" mode="book.titlepage.recto.auto.mode">
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="chapter.titlepage.recto.style" font-size="14.4pt" font-weight="bold">
<xsl:call-template name="component.title">
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="appendix.titlepage.recto.style" margin-left="{$title.margin.left}" font-size="14.4pt" font-weight="bold" font-family="{$title.fontset}">
<xsl:call-template name="component.title">
